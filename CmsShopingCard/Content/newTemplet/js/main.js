...
////    //determining when slick slider animation fire
////    windows.on('scroll', function () {
////        var scroll = windows.scrollTop();
////        if (scroll < 300) {
////            sticky.removeClass('is-sticky');
...
//////IIFE 
////var mainScriptController = function ($) {
...
////        Quantity
////    --------------------------------*/
////    var quantity = function (productQuantity, productId) {
////        $('.pro-qty').prepend('<span class="dec qtybtn">-</span>');
////        $('.pro-qty').append('<span class="inc qtybtn">+</span>');


////        //'.qtybtn' is plus$munse btn class
////        $('.qtybtn').on('click', function () {
////            var $button = $(this);
////            //get input val by perant
////            var oldValue = $button.parent().find('input').val();
////            debugger;
...
////        $('#qty-input').on("input focusout", function () {
////            debugger;
////            var button = $(this);
////            //get input val by perant
////            var inputNewVal = button.val();
////            var maxValue = button.attr('data-max-value');
////            var prevValue = button.attr('data-old-val');
